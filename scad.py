...
def add_shennie_atmega328p_arduino_compatible_breakout_arduino_uno_short_footprint_with_clamp(thing, **kwargs):
        ...
        #right hand uno header 2.54,20.32 at 24,7.027
        w = 2.54; h = 20.32; d = depth_clamp
        x_shift = 24; y_shift = 7.027; z_shift = 0
        cubes.append([[x_shift, y_shift, z_shift], [w,h,d]])
...
def add_shennie_atmega328p_arduino_compatible_breakout_arduino_uno_short_footprint_with_clamp_old_1(thing, **kwargs):
        #this is the clamp at both ends which is great but not the answer
        depth = kwargs.get("thickness", 3)
        pos = kwargs.get("pos", [0, 0, 0])
        height = kwargs.get("height", 3)
        width = kwargs.get("width", 3)
...
def add_shennie_atmega328p_arduino_compatible_breakout_cnc_shield(thing, **kwargs):
        #this is the clamp at end version which is great but not right
        depth = kwargs.get("thickness", 3)
        pos = kwargs.get("pos", [0, 0, 0])
        rot = kwargs.get("rot", [0, 0, 0])
        extra_lift = 3
